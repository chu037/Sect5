 ...
 dim url, url_back
  ...
  if not Ispostback Then
	...
	if m_date.text = "" then
	 ...
	 url_back = "s01cal_selday.aspx?m_date=" & m_date.text
   end if
  end sub
  ...
  if m_date_en.text <> nothing 
   if m_time_en.text = nothing then
    m_time_en.text = "17:30"
      ...
      Dim SQL As String
      SQL = "Insert Into calen (m_date, m_time, m_hours, m_note, m_messeng, m_date_en, m_time_en) Values(@m_date, @m_time, @m_hours, @m_note, @m_messeng, @m_date_en,@m_time_en)"
      ...
      Else
		 url = "s01cal_selday.aspx?m_date=" & m_date.text & "&m_add=1"
      End If

      Conn.Close()
else
      Dim SQL As String
      SQL = "Insert Into calen (m_date, m_time, m_hours, m_note, m_messeng, m_detail) Values(@m_date, @m_time, @m_hours, @m_note, @m_messeng, @m_detail)"
      Cmd = New OleDbCommand( SQL, Conn )
