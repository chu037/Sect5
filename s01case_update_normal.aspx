...
case_man.SelectedIndex =case_man.Items.IndexOf(case_man.Items.FindByValue(DataSet1.FieldValue("admin_id", Nothing)))
  ...
  Sub t1change(sender As Object, e As EventArgs)
   if case_man.selecteditem.text <> "" then
    t1.text = case_man.selecteditem.text
   end if
  end sub 
...
<table width="551" border="0" cellspacing="1" cellpadding="0">
  <tr>
    ...
    <td width="462" bgcolor="#FFCC99"><a href="s01cal_cal.aspx" target="_blank"></a>
      <asp:Button Enabled="false" ID="Button2" runat="server" Text="案件日期" OnClick="call_calst" />
...
<asp:Calendar
  ...
  <tr>
    ...
    <td bgcolor="#FFCC99">
	<asp:DropDownList AutoPostBack="true" Enabled="false" EnableViewState="false" ID="case_group" runat="server">
  ...
  <tr>
    ...
    <td bgcolor="#FFCC99">
	<asp:DropDownList AutoPostBack="true" DataSource="<%# dataset2.defaultview %>" DataTextField="s01name" DataTextFormatString="{0:g3}" DataValueField="admin_id" Enabled="false" ID="case_man" runat="server" OnSelectedIndexChanged="t1change" ></asp:DropDownList></td>
  </tr>
  <tr>
    <td bgcolor="#CCFFCC">內容：</td>
    <td bgcolor="#FFCC99"><asp:TextBox Columns="30" ID="case_content" ReadOnly="true" Rows="5" runat="server" text='<%# DataSet1.FieldValue("case_content", Container) %>' TextMode="MultiLine" Width="300" /></td>
  </tr>
  <tr>
    <td bgcolor="#CCFFCC">辦理情形：</td>
    <td bgcolor="#FFCC99"><asp:TextBox Columns="30" ID="case_result" ReadOnly="true" Rows="6" runat="server" text='<%# DataSet1.FieldValue("case_result", Container) %>' TextMode="MultiLine" Width="300" /></td>
  </tr>

  <tr>
    <td bgcolor="#CCFFCC">限辦天數</td>
    <td bgcolor="#FFCC99">
	  <asp:Button Enabled="false" ID="Button3" runat="server" Text="限辦日期" OnClick="call_calen" />
...
<br/>
  ...
  <tr>
    ...
    <td bgcolor="#FFCC99">
	<asp:DropDownList AutoPostBack="true" Enabled="false" ID="case_yes" runat="server">
  ...
  <tr>
    ...
    <td bgcolor="#FFCC99"><asp:Button Enabled="false" ID="Button5" runat="server" Text="結案日期" OnClick="call_calen_1" />
...
<br/>
  ...
  <p><span class="style1">
    <asp:Button Enabled="false" ID="Button1" runat="server" Text="更新" OnClick="UpdateData" />    
<input name="Submit2" type="reset" disabled="disabled" value="重新填寫" />
    </span>
    
      <span class="style1">
      <asp:Button ID="Buttonc" runat="server" Text="回上頁" OnClick='startcancel' />      
相關檔案：
<asp:Button ID="add_appen" runat="server" Text="結案檔案" OnClick= "trans_go" /></span>  
...
<asp:HyperLinkColumn
        ...
        Visible="True" target="case_update_blank" 
        HeaderText="檔案"/>
