...
CommandText='<%# "SELECT diff, m_date, m_hours, m_messeng, m_note, m_num, m_time, diffen, m_date_en  FROM s01_kc_calen  WHERE diff = 0 or diff < 0 and diffen > -1  ORDER BY m_date asc, m_time ASC" %>'
Debug="true"
></MM:DataSet>
<MM:DataSet 
id="DataSet2"
...
ConnectionString='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_STRING_s01") %>'
DatabaseType='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_DATABASETYPE_s01") %>'
CommandText='<%# "SELECT diff, m_date, m_hours, m_messeng, m_note, m_time, diffen, m_date_en, m_num  FROM s01_kc_calen  WHERE diff = 1   ORDER BY m_date asc, m_time ASC" %>'
Debug="true"
></MM:DataSet>
<MM:DataSet 
id="DataSet3"
...
ConnectionString='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_STRING_s01") %>'
DatabaseType='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_DATABASETYPE_s01") %>'
CommandText='<%# "SELECT diff, m_date, m_hours, m_messeng, m_note, m_time, m_num FROM s01_kc_calen  WHERE diff < ? and diff > 1  ORDER BY m_date asc, m_time ASC" %>'
PageSize="30"
Debug="true"
>
<parameters>
...
function showweek(t)
 ...
 showmessage = vt2 & "<br/>" & vt3 & "小時"
      ...
      Conn.Open()
      Dim SQL = "Select * From s01_kc_calen where m_date = @m_date" 
	  ...
	  'dim author_w3() = {"一組","二組","三組","四組"}
        ...
        While rd.Read()
            ...
            link.NavigateUrl = "kc_cal_detail.aspx?m_num=" & rd.item(3)
   ...
   Sub starsearch(sender As Object, e As EventArgs) 
	  ...
	  url0 = "kc_cal_search.aspx?m_date=" & m_date.text & "&m_date1=" & m_date1.text & "&m_messeng=" & trans(m_messeng.selecteditem.text) & "&m_note=" & trans(m_note.text)
...
<body>
    ...
    <h3 align="center"><strong><font color="#CC3300" size="+2" face="Verdana, 新細明體">處長室行事曆</font><font color="#339900" face="Verdana, 新細明體">新增或更改行程請點選日期</font></strong></h3>
...
>
        ...
        Visible="True">
                ...
                <asp:TemplateColumn
	    HeaderText="行程" ItemStyle-Width="15%" HeaderStyle-Width="15%"
        Visible="True">
