...
CommandText='<%# "SELECT m_date, m_date_en, m_detail, m_hours, m_messeng, m_note, m_num, m_time, m_time_en  FROM s01_kc_calen  WHERE m_num = ?" %>'
Debug="true"
>
  <Parameters>
    <Parameter  Name="@m_num"  Value='<%# IIf((Request.QueryString("m_num") <> Nothing), Request.QueryString("m_num"), "") %>'  Type="Integer"   />    </Parameters>
</MM:DataSet>
<MM:DataSet 
id="DataSet2"
runat="Server"
...
ConnectionString='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_STRING_s01") %>'
DatabaseType='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_DATABASETYPE_s01") %>'
CommandText='<%# "SELECT *  FROM kc_calen_appen  WHERE m_num = ?  ORDER BY m_appen_id ASC" %>'
Debug="true"
>
  <Parameters>
