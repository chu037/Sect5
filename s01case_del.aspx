...
runat="server"
CommandText='<%# "DELETE FROM s01case WHERE case_id=?" %>'
...
CreateDataSet="false"
SuccessURL='<%# "s01case_admin.aspx?case_add=3" %>'
Debug="true"
><Parameters>
  <Parameter Name="@case_id" Value='<%# IIf((Request.QueryString("case_id") <> Nothing), Request.QueryString("case_id"), "") %>' Type="Integer" /></Parameters>
</MM:Delete>
