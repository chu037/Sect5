...
CommandText='<%# "SELECT * FROM kc_calen_appen WHERE m_num = ? ORDER BY m_appen_id DESC" %>'
Debug="true"
><Parameters>
...
<asp:TemplateColumn HeaderText="修改" 
        Visible="True">
  <ItemTemplate>
    <input name="Submit3" type="submit" onclick="MM_goToURL('self','kc_cal_upfile_update.aspx?m_appen_id=<%# DataSet2.FieldValue("m_appen_id", Container) %>');return document.MM_returnValue" value="修改" />
  </ItemTemplate>
</asp:TemplateColumn>
      </Columns>
  </asp:DataGrid>
...
<script language="VB" runat="server">
 ...
 Sub goback(sender As Object, e As EventArgs)
  ...
  if m_numcheck <> nothing then
   url_goback = "kc_cal_update.aspx?m_num=" & m_numcheck 
...
Function GetFileName(ServerPath, FileName)
  ...
  Sub InsertData(sender As Object, e As EventArgs) 
	...
	if IsValid Then
      ...
      Dim SQL As String
      SQL = "Insert Into kc_calen_appen (m_num, m_appen, m_appen_con) Values(@m_num, @m_appen, @m_appen_con)"
