...
CommandText='<%# "SELECT * FROM calen_appen WHERE m_appen_id = ?" %>'
Debug="true"
>
  <Parameters>
...
<script language="VB" runat="server">
 ...
 Sub goback(sender As Object, e As EventArgs)
  dim url_goback
   url_goback = "s01cal_upfile.aspx?m_num=" & m_num.text 
...
Function GetFileName(ServerPath, FileName)
  ...
  Sub updateData(sender As Object, e As EventArgs) 
      ...
      Dim SQL As String
      SQL = "UPDATE calen_appen SET m_num=@m_num, m_appen=@m_appen, m_appen_con= @m_appen_con where m_appen_id=@m_appen_id"
      ...
      Else
		 url = "s01cal_upfile.aspx?m_num=" & m_num.text
      End If
